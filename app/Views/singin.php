...
<head>
    ...
    <hr>
        ...
        <div class="container col-sm-6" style="background-color:#F2F2F2; padding:50px;">
            <form id="signup" action="http://labs.iam.cat/~a17adrposmon/wishes/public/home/newuser" class="text-left" method="post">
                ...
                <input id="submit" type="button" onclick="pswValidation()" style="margin-left:16%;margin-top: 10px; border: none; background-color: black; color: white; padding: 8px 20px 8px 20px;" value="Send">
            </form>
        </div>

    </div>

    <script src="http://labs.iam.cat/~a17adrposmon/wishes/public/Assets/js/main.js"></script>
</body>
</html>