...
<div class="row"> 
  <div class="column">
    ...
    <div class="container col-sm-12" id="products">
        <img id="productimg" src="../Assets/img/<?php echo $row?>.jpg" alt="Imagen producto" style="width:50%; border-style:solid; border-color:grey;">
        <button id="btnproduct" class="btn" role="link" onclick="window.location='product?arg=<?php echo $row?>'">Profile</button>
        <?php 
         if (isset($_SESSION['name'])){?>
          <button id="btnwish" class="btn" role="link" onclick="window.location='wish?arg=<?php echo $row?>'">Wish</button>
   <?php }?>
    </div>
    <?php
    }
